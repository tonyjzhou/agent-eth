# https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#functions "Direct link to Functions")
### constructor[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#constructor "Direct link to constructor")
```
constructor(IPoolManager _manager)PoolTestBase(_manager);
```

### swap[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#swap "Direct link to swap")
```
functionswap(PoolKey memory key, IPoolManager.SwapParams memory params)externalpayable;
```

### unlockCallback[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#unlockcallback "Direct link to unlockCallback")
```
functionunlockCallback(bytescalldata rawData)externalreturns(bytesmemory);
```

## Errors[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#errors "Direct link to Errors")
### NoSwapOccurred[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#noswapoccurred "Direct link to NoSwapOccurred")
```
error NoSwapOccurred();
```

## Structs[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#structs "Direct link to Structs")
### CallbackData[​](https://docs.uniswap.org/contracts/v4/reference/core/test/SwapRouterNoChecks#callbackdata "Direct link to CallbackData")
```
structCallbackData{address sender;  PoolKey key;  IPoolManager.SwapParams params;}
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/SwapRouterNoChecks.md)
Was this helpful?
[PreviousSqrtPriceMathEchidnaTest](https://docs.uniswap.org/contracts/v4/reference/core/test/SqrtPriceMathEchidnaTest)[NextTestERC20](https://docs.uniswap.org/contracts/v4/reference/core/test/TestERC20)
On this page
