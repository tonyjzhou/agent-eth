...
### _quoteExactInputSingle[​](https://docs.uniswap.org/contracts/v4/reference/periphery/lens/V4Quoter#_quoteexactinputsingle "Direct link to _quoteExactInputSingle")
