# https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId#functions "Direct link to Functions")
### toId[​](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId#toid "Direct link to toId")
Returns value equal to keccak256(abi.encode(poolKey))
```
functiontoId(PoolKey memory poolKey)internalpurereturns(PoolId poolId);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/types/PoolId.md)
Was this helpful?
[PreviousCurrency](https://docs.uniswap.org/contracts/v4/reference/core/types/Currency)[NextPoolKey](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolKey)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId#functions)
    * [toId](https://docs.uniswap.org/contracts/v4/reference/core/types/PoolId#toid)
