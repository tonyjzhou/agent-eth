# https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#__docusaurus_skipToContent_fallback)
...
## State Variables[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#state-variables "Direct link to State Variables")
### IS_UNLOCKED_SLOT[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#is_unlocked_slot "Direct link to IS_UNLOCKED_SLOT")
```
bytes32internalconstant IS_UNLOCKED_SLOT =0xc090fc4683624cfc3884e9d8de5eca132f2d0ec062aff75d43c0465d5ceeab23;
```

## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#functions "Direct link to Functions")
### unlock[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#unlock "Direct link to unlock")
```
functionunlock()internal;
```

### lock[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#lock-1 "Direct link to lock")
```
functionlock()internal;
```

### isUnlocked[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#isunlocked "Direct link to isUnlocked")
```
functionisUnlocked()internalviewreturns(bool unlocked);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/libraries/Lock.md)
Was this helpful?
[PreviousLiquidityMath](https://docs.uniswap.org/contracts/v4/reference/core/libraries/LiquidityMath)[NextNonzeroDeltaCount](https://docs.uniswap.org/contracts/v4/reference/core/libraries/NonzeroDeltaCount)
On this page
  * [State Variables](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#state-variables)
    * [IS_UNLOCKED_SLOT](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Lock#is_unlocked_slot)
