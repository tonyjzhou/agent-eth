# https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims#functions "Direct link to Functions")
### mint[​](https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims#mint "Direct link to mint")
mocked mint logic
```
functionmint(address to,uint256 id,uint256 amount)public;
```

### burn[​](https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims#burn "Direct link to burn")
mocked burn logic
```
functionburn(uint256 id,uint256 amount)public;
```

### burnFrom[​](https://docs.uniswap.org/contracts/v4/reference/core/test/MockERC6909Claims#burnfrom "Direct link to burnFrom")
mocked burn logic without checking sender allowance
```
functionburnFrom(addressfrom,uint256 id,uint256 amount)public;
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/MockERC6909Claims.md)
Was this helpful?
[PreviousMockContract](https://docs.uniswap.org/contracts/v4/reference/core/test/MockContract)[NextMockHooks](https://docs.uniswap.org/contracts/v4/reference/core/test/MockHooks)
On this page
