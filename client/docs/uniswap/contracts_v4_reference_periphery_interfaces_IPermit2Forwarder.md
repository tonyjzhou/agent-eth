# https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#functions "Direct link to Functions")
### permit[​](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#permit "Direct link to permit")
...
### permitBatch[​](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#permitbatch "Direct link to permitBatch")
...
---|---|---  
`err`| `bytes`| the error returned by a reverting permit call, empty if successful  
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder.md)
Was this helpful?
[PreviousINotifier](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/INotifier)[NextIPoolInitializer_v4](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPoolInitializer_v4)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#functions)
    * [permit](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#permit)
    * [permitBatch](https://docs.uniswap.org/contracts/v4/reference/periphery/interfaces/IPermit2Forwarder#permitbatch)
