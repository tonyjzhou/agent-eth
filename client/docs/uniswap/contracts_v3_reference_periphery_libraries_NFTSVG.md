# https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG

[Skip to main content](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#functions "Direct link to Functions")
### generateSVG[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#generatesvg "Direct link to generateSVG")
```
functiongenerateSVG()internalreturns(string svg)
```

### getCurve[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#getcurve "Direct link to getCurve")
```
functiongetCurve()internalreturns(string curve)
```

### generateSVGCurveCircle[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#generatesvgcurvecircle "Direct link to generateSVGCurveCircle")
```
functiongenerateSVGCurveCircle()internalreturns(string svg)
```

### rangeLocation[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#rangelocation "Direct link to rangeLocation")
```
functionrangeLocation()internalreturns(string,string)
```

### isRare[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#israre "Direct link to isRare")
```
functionisRare()internalreturns(bool)
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v3/reference/periphery/libraries/NFTSVG.md)
Was this helpful?
[PreviousNFTDescriptor](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTDescriptor)[NextOracleLibrary](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/OracleLibrary)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#functions)
    * [generateSVG](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#generatesvg)
    * [getCurve](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#getcurve)
    * [generateSVGCurveCircle](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#generatesvgcurvecircle)
    * [rangeLocation](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#rangelocation)
    * [isRare](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/NFTSVG#israre)
