# https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions

[Skip to main content](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#__docusaurus_skipToContent_fallback)
...
## Table of contents[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#table-of-contents "Direct link to Table of contents")
### Properties[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#properties "Direct link to Properties")
...
## Properties[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#properties-1 "Direct link to Properties")
### fee[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#fee "Direct link to fee")
• **fee** : `Percent`
The percent of the output that will be taken as a fee.
#### Defined in[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#defined-in "Direct link to Defined in")
[payments.ts:11](https://github.com/Uniswap/v3-sdk/blob/08a7c05/src/payments.ts#L11)
### recipient[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#recipient "Direct link to recipient")
• **recipient** : `string`
The recipient of the fee.
#### Defined in[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#defined-in-1 "Direct link to Defined in")
[payments.ts:16](https://github.com/Uniswap/v3-sdk/blob/08a7c05/src/payments.ts#L16)
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/sdk/v3/reference/interfaces/FeeOptions.md)
Was this helpful?
[PreviousCommonAddLiquidityOptions](https://docs.uniswap.org/sdk/v3/reference/interfaces/CommonAddLiquidityOptions)[NextIncentiveKey](https://docs.uniswap.org/sdk/v3/reference/interfaces/IncentiveKey)
On this page
  * [Table of contents](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#table-of-contents)
    * [Properties](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#properties)
  * [Properties](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#properties-1)
    * [fee](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#fee)
    * [recipient](https://docs.uniswap.org/sdk/v3/reference/interfaces/FeeOptions#recipient)
