# https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9

[Skip to main content](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#__docusaurus_skipToContent_fallback)
...
On this page
# IWETH9
## Functions[​](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#functions "Direct link to Functions")
### deposit[​](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#deposit "Direct link to deposit")
```
functiondeposit()external
```

Deposit ether to get wrapped ether
### withdraw[​](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#withdraw "Direct link to withdraw")
```
functionwithdraw()external
```

Withdraw wrapped ether to get ether
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v3/reference/periphery/interfaces/external/IWETH9.md)
Was this helpful?
[PreviousIERC20PermitAllowed](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IERC20PermitAllowed)[NextQuoter](https://docs.uniswap.org/contracts/v3/reference/periphery/lens/Quoter)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#functions)
    * [deposit](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#deposit)
    * [withdraw](https://docs.uniswap.org/contracts/v3/reference/periphery/interfaces/external/IWETH9#withdraw)
