# https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes#__docusaurus_skipToContent_fallback)
...
_parseSelector also is used to parse the expected selector For parsing hook returns, note that all hooks return either bytes4 or (bytes4, 32-byte-delta) or (bytes4, 32-byte-delta, uint24)._
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes#functions "Direct link to Functions")
### parseSelector[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes#parseselector "Direct link to parseSelector")
```
functionparseSelector(bytesmemory result)internalpurereturns(bytes4 selector);
```

### parseFee[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes#parsefee "Direct link to parseFee")
```
functionparseFee(bytesmemory result)internalpurereturns(uint24 lpFee);
```

### parseReturnDelta[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/ParseBytes#parsereturndelta "Direct link to parseReturnDelta")
```
functionparseReturnDelta(bytesmemory result)internalpurereturns(int256 hookReturn);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/libraries/ParseBytes.md)
Was this helpful?
[PreviousNonzeroDeltaCount](https://docs.uniswap.org/contracts/v4/reference/core/libraries/NonzeroDeltaCount)[NextPool](https://docs.uniswap.org/contracts/v4/reference/core/libraries/Pool)
On this page
