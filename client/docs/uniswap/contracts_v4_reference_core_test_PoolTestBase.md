# https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#__docusaurus_skipToContent_fallback)
[Uniswap Docs](https://docs.uniswap.org/)
Search`⌘``K`
[Submit Feedback](https://docs.google.com/forms/d/e/1FAIpQLSdjSkZam8KiatL9XACRVxCHjDJjaPGbls77PCXDKFn4JwykXg/viewform)
  * [Concepts](https://docs.uniswap.org/concepts/overview)
  * [Contracts](https://docs.uniswap.org/contracts/v4/overview)
    * [v4 Protocol](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
      * [Overview](https://docs.uniswap.org/contracts/v4/overview)
      * [Deployments](https://docs.uniswap.org/contracts/v4/deployments)
      * [Concepts](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
      * [Quickstart](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
        * [Create Pool](https://docs.uniswap.org/contracts/v4/quickstart/create-pool)
        * [Manage Liquidity](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
        * [Swap](https://docs.uniswap.org/contracts/v4/quickstart/swap)
        * [Hooks](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
        * [Subscriber](https://docs.uniswap.org/contracts/v4/quickstart/subscriber)
      * [Guides](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
      * [Technical Reference](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
        * [Errors](https://docs.uniswap.org/contracts/v4/reference/errors/)
        * [Core](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
          * [Libraries](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
          * [Types](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
          ...
          * [interfaces](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
          * [test](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
        ...
        * [Periphery](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [v3 Protocol](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [Smart Wallet](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [UniswapX](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [Universal Router](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [Permit2](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [v2 Protocol](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
    * [v1 Protocol](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
...
## State Variables[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#state-variables "Direct link to State Variables")
### manager[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#manager "Direct link to manager")
```
IPoolManager public immutable manager;
```

## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#functions "Direct link to Functions")
### constructor[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#constructor "Direct link to constructor")
```
constructor(IPoolManager _manager);
```

### _fetchBalances[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase#_fetchbalances "Direct link to _fetchBalances")
```
function_fetchBalances(Currency currency,address user,address deltaHolder)internalviewreturns(uint256 userBalance,uint256 poolBalance,int256 delta);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/PoolTestBase.md)
Was this helpful?
[PreviousPoolTakeTest](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest)[NextProtocolFeesImplementation](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation)
On this page
