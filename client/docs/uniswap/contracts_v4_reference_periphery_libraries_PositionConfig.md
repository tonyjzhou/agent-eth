# https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig#__docusaurus_skipToContent_fallback)
...
```
structPositionConfig{  PoolKey poolKey;int24 tickLower;int24 tickUpper;}
```
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig#functions "Direct link to Functions")
### toId[​](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig#toid "Direct link to toId")
```
functiontoId(PositionConfig calldata config)internalpurereturns(bytes32 id);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/periphery/libraries/PositionConfig.md)
Was this helpful?
[PreviousPathKey](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey)[NextPositionConfigId](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfigId)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig#functions)
    * [toId](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig#toid)
