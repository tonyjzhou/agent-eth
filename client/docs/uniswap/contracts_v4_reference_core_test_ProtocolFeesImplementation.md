# https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#__docusaurus_skipToContent_fallback)
...
## State Variables[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#state-variables "Direct link to State Variables")
### _pools[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#_pools "Direct link to _pools")
```
mapping(PoolId id => Pool.State)internal _pools;
```

### isUnlocked[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#isunlocked "Direct link to isUnlocked")
```
boolinternal isUnlocked;
```

## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#functions "Direct link to Functions")
### constructor[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#constructor "Direct link to constructor")
```
constructor()ProtocolFees(msg.sender);
```

### setPrice[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#setprice "Direct link to setPrice")
```
functionsetPrice(PoolKey memory key,uint160 sqrtPriceX96)public;
```

### _getPool[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#_getpool "Direct link to _getPool")
```
function_getPool(PoolId id)internalview override returns(Pool.State storage);
```

### setIsUnlocked[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#setisunlocked "Direct link to setIsUnlocked")
```
functionsetIsUnlocked(bool newValue)public;
```

### _isUnlocked[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#_isunlocked "Direct link to _isUnlocked")
```
function_isUnlocked()internalview override returns(bool);
```

### updateProtocolFees[​](https://docs.uniswap.org/contracts/v4/reference/core/test/ProtocolFeesImplementation#updateprotocolfees "Direct link to updateProtocolFees")
```
functionupdateProtocolFees(Currency currency,uint256 amount)public;
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/ProtocolFeesImplementation.md)
Was this helpful?
[PreviousPoolTestBase](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)[NextProxyPoolManager](https://docs.uniswap.org/contracts/v4/reference/core/test/ProxyPoolManager)
On this page
