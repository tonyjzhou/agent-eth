# https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey#__docusaurus_skipToContent_fallback)
...
```
structPathKey{  Currency intermediateCurrency;uint24 fee;int24 tickSpacing;  IHooks hooks;bytes hookData;}
```
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey#functions "Direct link to Functions")
### getPoolAndSwapDirection[​](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey#getpoolandswapdirection "Direct link to getPoolAndSwapDirection")
Get the pool and swap direction for a given PathKey
```
functiongetPoolAndSwapDirection(PathKey calldata params, Currency currencyIn)internalpurereturns(PoolKey memory poolKey,bool zeroForOne);
```
...
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/periphery/libraries/PathKey.md)
Was this helpful?
[PreviousLocker](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/Locker)[NextPositionConfig](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PositionConfig)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey#functions)
    * [getPoolAndSwapDirection](https://docs.uniswap.org/contracts/v4/reference/periphery/libraries/PathKey#getpoolandswapdirection)
