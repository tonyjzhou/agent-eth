# https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#__docusaurus_skipToContent_fallback)
...
## State Variables[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#state-variables "Direct link to State Variables")
### poolManager[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#poolmanager "Direct link to poolManager")
The Uniswap v4 PoolManager contract
```
IPoolManager public immutable poolManager;
```

## Functions[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#functions "Direct link to Functions")
### onlyPoolManager[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#onlypoolmanager "Direct link to onlyPoolManager")
Only allow calls from the PoolManager contract
```
modifieronlyPoolManager();
```

### constructor[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#constructor "Direct link to constructor")
```
constructor(IPoolManager _poolManager);
```

## Errors[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#errors "Direct link to Errors")
### NotPoolManager[​](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#notpoolmanager "Direct link to NotPoolManager")
Thrown when the caller is not PoolManager
```
error NotPoolManager();
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/periphery/base/ImmutableState.md)
Was this helpful?
[PreviousERC721Permit_v4](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ERC721Permit_v4)[NextMulticall_v4](https://docs.uniswap.org/contracts/v4/reference/periphery/base/Multicall_v4)
On this page
  ...
  * [Functions](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#functions)
    * [onlyPoolManager](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#onlypoolmanager)
    * [constructor](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#constructor)
  * [Errors](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#errors)
    * [NotPoolManager](https://docs.uniswap.org/contracts/v4/reference/periphery/base/ImmutableState#notpoolmanager)
