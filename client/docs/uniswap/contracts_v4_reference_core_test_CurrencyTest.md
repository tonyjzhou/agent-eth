# https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#functions "Direct link to Functions")
### transfer[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#transfer "Direct link to transfer")
```
functiontransfer(Currency currency,address to,uint256 amount)external;
```

### balanceOfSelf[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#balanceofself "Direct link to balanceOfSelf")
```
functionbalanceOfSelf(Currency currency)externalviewreturns(uint256);
```

### balanceOf[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#balanceof "Direct link to balanceOf")
```
functionbalanceOf(Currency currency,address owner)externalviewreturns(uint256);
```

### isAddressZero[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#isaddresszero "Direct link to isAddressZero")
```
functionisAddressZero(Currency currency)externalpurereturns(bool);
```

### toId[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#toid "Direct link to toId")
```
functiontoId(Currency currency)externalpurereturns(uint256);
```

### fromId[​](https://docs.uniswap.org/contracts/v4/reference/core/test/CurrencyTest#fromid "Direct link to fromId")
```
functionfromId(uint256 id)externalpurereturns(Currency);
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/CurrencyTest.md)
Was this helpful?
[PreviousBaseTestHooks](https://docs.uniswap.org/contracts/v4/reference/core/test/BaseTestHooks)[NextCustomCurveHook](https://docs.uniswap.org/contracts/v4/reference/core/test/CustomCurveHook)
On this page
