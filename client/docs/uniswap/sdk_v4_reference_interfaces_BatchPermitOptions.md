# https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions

[Skip to main content](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#__docusaurus_skipToContent_fallback)
...
On this page
# BatchPermitOptions
[@uniswap/v4-sdk](https://docs.uniswap.org/sdk/v4/reference/overview) / BatchPermitOptions
...
## Properties[​](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#properties "Direct link to Properties")
### owner[​](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#owner "Direct link to owner")
> **owner** : `string`
...
### permitBatch[​](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#permitbatch "Direct link to permitBatch")
...
### signature[​](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#signature "Direct link to signature")
> **signature** : `string`
...
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/sdk/v4/reference/interfaces/BatchPermitOptions.md)
Was this helpful?
[PreviousAllowanceTransferPermitSingle](https://docs.uniswap.org/sdk/v4/reference/interfaces/AllowanceTransferPermitSingle)[NextBestTradeOptions](https://docs.uniswap.org/sdk/v4/reference/interfaces/BestTradeOptions)
On this page
  * [Properties](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#properties)
    * [owner](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#owner)
    * [permitBatch](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#permitbatch)
    * [signature](https://docs.uniswap.org/sdk/v4/reference/interfaces/BatchPermitOptions#signature)
