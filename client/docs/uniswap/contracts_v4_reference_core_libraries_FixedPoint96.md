# https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint96

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint96#__docusaurus_skipToContent_fallback)
...
## State Variables[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint96#state-variables "Direct link to State Variables")
### RESOLUTION[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint96#resolution "Direct link to RESOLUTION")
```
uint8internalconstant RESOLUTION =96;
```

### Q96[​](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint96#q96 "Direct link to Q96")
```
uint256internalconstant Q96 =0x1000000000000000000000000;
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/libraries/FixedPoint96.md)
Was this helpful?
[PreviousFixedPoint128](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FixedPoint128)[NextFullMath](https://docs.uniswap.org/contracts/v4/reference/core/libraries/FullMath)
On this page
