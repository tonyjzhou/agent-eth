# https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest

[Skip to main content](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest#__docusaurus_skipToContent_fallback)
...
On this page
# TickLensTest
## Functions[​](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest#functions "Direct link to Functions")
### getGasCostOfGetPopulatedTicksInWord[​](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest#getgascostofgetpopulatedticksinword "Direct link to getGasCostOfGetPopulatedTicksInWord")
```
functiongetGasCostOfGetPopulatedTicksInWord()externalreturns(uint256)
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v3/reference/periphery/test/TickLensTest.md)
Was this helpful?
[PreviousTestUniswapV3Callee](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TestUniswapV3Callee)[NextNonfungiblePositionManager](https://docs.uniswap.org/contracts/v3/reference/periphery/NonfungiblePositionManager)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest#functions)
    * [getGasCostOfGetPopulatedTicksInWord](https://docs.uniswap.org/contracts/v3/reference/periphery/test/TickLensTest#getgascostofgetpopulatedticksinword)
