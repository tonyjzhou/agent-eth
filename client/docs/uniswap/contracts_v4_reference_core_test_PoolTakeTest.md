# https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest

[Skip to main content](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#__docusaurus_skipToContent_fallback)
...
## Functions[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#functions "Direct link to Functions")
### constructor[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#constructor "Direct link to constructor")
```
constructor(IPoolManager _manager)PoolTestBase(_manager);
```

### take[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#take "Direct link to take")
```
functiontake(PoolKey memory key,uint256 amount0,uint256 amount1)externalpayable;
```

### unlockCallback[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#unlockcallback "Direct link to unlockCallback")
```
functionunlockCallback(bytescalldata rawData)externalreturns(bytesmemory);
```

### _testTake[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#_testtake "Direct link to _testTake")
```
function_testTake(Currency currency,address sender,uint256 amount)internal;
```

## Structs[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#structs "Direct link to Structs")
### CallbackData[​](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTakeTest#callbackdata "Direct link to CallbackData")
```
structCallbackData{address sender;  PoolKey key;uint256 amount0;uint256 amount1;}
```

[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v4/reference/core/test/PoolTakeTest.md)
Was this helpful?
[PreviousPoolSwapTest](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolSwapTest)[NextPoolTestBase](https://docs.uniswap.org/contracts/v4/reference/core/test/PoolTestBase)
On this page
