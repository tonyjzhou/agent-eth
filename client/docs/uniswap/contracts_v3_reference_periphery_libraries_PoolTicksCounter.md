# https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter

[Skip to main content](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter#__docusaurus_skipToContent_fallback)
...
On this page
# PoolTicksCounter
## Functions[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter#functions "Direct link to Functions")
### countInitializedTicksCrossed[​](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter#countinitializedtickscrossed "Direct link to countInitializedTicksCrossed")
```
functioncountInitializedTicksCrossed()internalviewreturns(uint32 initializedTicksCrossed)
```
...
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v3/reference/periphery/libraries/PoolTicksCounter.md)
Was this helpful?
[PreviousPoolAddress](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolAddress)[NextPositionKey](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PositionKey)
On this page
  * [Functions](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter#functions)
    * [countInitializedTicksCrossed](https://docs.uniswap.org/contracts/v3/reference/periphery/libraries/PoolTicksCounter#countinitializedtickscrossed)
