...
[Skip to main content](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/oracles#__docusaurus_skipToContent_fallback)
...
## Manipulation resistance[​](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/oracles#manipulation-resistance "Direct link to Manipulation resistance")
...
# Building an oracle
To learn more about building oracles check out [building an Oracle](https://docs.uniswap.org/contracts/v2/guides/smart-contract-integration/building-an-oracle) in the developer guides.
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/contracts/v2/concepts/02-core-concepts/04-oracles.md)
Was this helpful?
[PreviousFlash Swaps](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/flash-swaps)[NextFees](https://docs.uniswap.org/contracts/v2/concepts/advanced-topics/fees)
On this page
  * [Manipulation resistance](https://docs.uniswap.org/contracts/v2/concepts/core-concepts/oracles#manipulation-resistance)
