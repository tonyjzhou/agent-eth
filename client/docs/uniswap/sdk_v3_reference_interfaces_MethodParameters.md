# https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters

[Skip to main content](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#__docusaurus_skipToContent_fallback)
...
## Table of contents[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#table-of-contents "Direct link to Table of contents")
### Properties[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#properties "Direct link to Properties")
...
## Properties[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#properties-1 "Direct link to Properties")
### calldata[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#calldata "Direct link to calldata")
• **calldata** : `string`
The hex encoded calldata to perform the given operation
#### Defined in[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#defined-in "Direct link to Defined in")
[utils/calldata.ts:11](https://github.com/Uniswap/v3-sdk/blob/08a7c05/src/utils/calldata.ts#L11)
### value[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#value "Direct link to value")
• **value** : `string`
The amount of ether (wei) to send in hex.
#### Defined in[​](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#defined-in-1 "Direct link to Defined in")
[utils/calldata.ts:15](https://github.com/Uniswap/v3-sdk/blob/08a7c05/src/utils/calldata.ts#L15)
[Edit this page](https://github.com/uniswap/uniswap-docs/tree/main/docs/sdk/v3/reference/interfaces/MethodParameters.md)
Was this helpful?
[PreviousIncreaseSpecificOptions](https://docs.uniswap.org/sdk/v3/reference/interfaces/IncreaseSpecificOptions)[NextMintSpecificOptions](https://docs.uniswap.org/sdk/v3/reference/interfaces/MintSpecificOptions)
On this page
  * [Table of contents](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#table-of-contents)
    * [Properties](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#properties)
  * [Properties](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#properties-1)
    * [calldata](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#calldata)
    * [value](https://docs.uniswap.org/sdk/v3/reference/interfaces/MethodParameters#value)
